...
class SharedPreferencesHelper(context: Context) {
    ...
    companion object {
        ...
        const val KEY_VISIT_COUNT = "visit_count" //Para contar las visitas a la app
    }
    ...
    // Guardar y obtener contador para las visitas de la app
    fun saveVisitCount(count: Int) {
        editor.putInt(KEY_VISIT_COUNT, count).apply()
    }

    fun getVisitCount(): Int {
        return sharedPreferences.getInt(KEY_VISIT_COUNT, 0)
    }

    fun resetVisitCount() {
        editor.putInt(KEY_VISIT_COUNT, 0).apply()
    }
